...
type TaskService interface {
	...
	GetTaskList(ctx context.Context, in *TaskRequest, opts ...client.CallOption) (*TaskListResponse, error)
...
func (c *taskService) GetTaskList(ctx context.Context, in *TaskRequest, opts ...client.CallOption) (*TaskListResponse, error) {
	req := c.c.NewRequest(c.name, "TaskService.GetTaskList", in)
...
type TaskServiceHandler interface {
	...
	GetTaskList(context.Context, *TaskRequest, *TaskListResponse) error
...
func RegisterTaskServiceHandler(s server.Server, hdlr TaskServiceHandler, opts ...server.HandlerOption) error {
	type taskService interface {
		...
		GetTaskList(ctx context.Context, in *TaskRequest, out *TaskListResponse) error
...
func (h *taskServiceHandler) GetTaskList(ctx context.Context, in *TaskRequest, out *TaskListResponse) error {
	return h.TaskServiceHandler.GetTaskList(ctx, in, out)
}
